        ...
        {mobileOpen && (
          <>
            ...
            <motion.aside
              ...
              className={`fixed top-0 right-0 bottom-0 w-[85vw] sm:w-[80vw] max-w-[360px] border-l border-cyan-glow/15 dark:border-white/10 z-[101] flex flex-col md:hidden shadow-2xl`}
              style={{
            ...
            >
              {/* Sidebar Header (Theme toggle, Audio toggle, and Close button) - fixed at the top */}
              <div className={`h-16 flex items-center justify-between px-6 border-b border-slate-200/60 dark:border-white/10 ${
                lang === 'ar' ? 'flex-row-reverse' : ''
              }`}>
                {/* Utilities (Theme & Audio) */}
                <div className="flex items-center gap-3">
                  {/* Theme Toggle Button */}
                  <button 
                    onClick={handleThemeToggle}
                    className="p-2.5 rounded-full border border-slate-300 dark:border-white/10 bg-slate-100 hover:bg-slate-200 text-slate-700 dark:bg-white/5 dark:hover:bg-cyan-glow/10 dark:text-gray-400 dark:hover:text-cyan-glow dark:hover:border-cyan-glow/40 active:scale-95 transition-all duration-300 touch-manipulation flex items-center justify-center"
                ...
                <button
                  onClick={closeMobile}
                  className="w-10 h-10 rounded-full border border-slate-300 dark:border-white/10 bg-slate-100 hover:bg-slate-200 text-slate-700 dark:bg-white/5 dark:hover:bg-cyan-glow/10 dark:text-gray-400 dark:hover:text-cyan-glow dark:hover:border-cyan-glow/40 active:scale-95 transition-all duration-300 touch-manipulation flex items-center justify-center"
              ...
              <div className={`flex-1 flex flex-col justify-between overflow-y-auto no-scrollbar px-6 pt-6 pb-8 ${
                      ...
                      return (
                        <li key={item.href} className="w-full">
                          <motion.a
                            ...
                            className={`group relative flex items-center w-full py-4 ${
                              lang === 'ar' ? 'pr-5 pl-4 justify-end text-right' : 'pl-5 pr-4 justify-start text-left'
                            } rounded-xl font-sans font-medium text-base tracking-[0.03em] cursor-none transition-all duration-300 ${
                              isActive
                                ? 'text-cyan-glow bg-sky-50/20 dark:bg-cyan-glow/[0.10] font-semibold'
                                : 'text-slate-200 dark:text-slate-100 hover:text-cyan-glow hover:bg-sky-50/20 dark:hover:bg-cyan-glow/[0.10] dark:hover:text-cyan-glow'
                            }`}
                          >
                            ...
                            <span 
                              ...
                              } top-1/2 -translate-y-1/2 w-1 h-5 bg-sky-600 dark:bg-cyan-glow shadow-[0_0_8px_rgba(2,132,199,0.3)] dark:shadow-[0_0_12px_#00f2ff] transition-all duration-300 ${
                ...
                <div className="flex flex-col gap-3.5 w-full mt-8">
                  <button
                    ...
                    className="w-full h-12 rounded-xl border border-slate-300 bg-slate-100 hover:bg-slate-200 text-slate-700 dark:border-cyan-glow/20 dark:bg-navy-800/40 dark:text-cyan-glow dark:hover:bg-cyan-glow/10 dark:hover:border-cyan-glow/40 active:scale-98 transition-all duration-300 cursor-none flex items-center justify-center gap-2"
                  >
